...
class LanguageLabsAidaTrustRecitationProtoDocAttribution extends \Google\Model
{
  /**
   * @var string
   */
...
class_alias(LanguageLabsAidaTrustRecitationProtoDocAttribution::class, 'Google_Service_Aiplatform_LanguageLabsAidaTrustRecitationProtoDocAttribution');
