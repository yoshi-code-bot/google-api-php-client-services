...
class RollUpDataPointsRequest extends \Google\Model
{
   ...
   * source was registered through this API with the same OAuth client ID as the
   * caller. Callers that were only granted write scopes for the requested data
   * type may only read the data they wrote themselves: their requests are
