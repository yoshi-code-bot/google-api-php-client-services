...
class CustomerProfileTechnology extends \Google\Collection
{
...
class_alias(CustomerProfileTechnology::class, 'Google_Service_ThreatIntelligenceService_CustomerProfileTechnology');
