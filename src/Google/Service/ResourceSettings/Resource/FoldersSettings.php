 ...
 *  </code>
 */
class Google_Service_ResourceSettings_Resource_FoldersSettings extends Google_Service_Resource
{
  /**
   ...
   */
  public function listFoldersSettings($parent, $optParams = array())
  {
