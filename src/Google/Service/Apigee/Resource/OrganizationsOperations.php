...
class Google_Service_Apigee_Resource_OrganizationsOperations extends Google_Service_Resource
{
   ...
   * @param Google_Service_Apigee_GoogleLongrunningCancelOperationRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_Apigee_GoogleProtobufEmpty
   */
  public function cancel($name, Google_Service_Apigee_GoogleLongrunningCancelOperationRequest $postBody, $optParams = array())
  {
    $params = array('name' => $name, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('cancel', array($params), "Google_Service_Apigee_GoogleProtobufEmpty");
  }
  /**
