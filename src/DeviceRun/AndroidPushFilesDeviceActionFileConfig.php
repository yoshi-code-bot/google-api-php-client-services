...
class AndroidPushFilesDeviceActionFileConfig extends \Google\Model
{
  /**
...
class_alias(AndroidPushFilesDeviceActionFileConfig::class, 'Google_Service_DeviceRun_AndroidPushFilesDeviceActionFileConfig');
