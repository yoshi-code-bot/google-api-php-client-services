...
class RetrieveToolsResponse extends \Google\Collection
{
...
class_alias(RetrieveToolsResponse::class, 'Google_Service_CustomerEngagementSuite_RetrieveToolsResponse');
