...
class Post extends \Google\Model
{
   ...
   * @var bool
   */
  public $fromImportedSpreadsheet;
  /**
   ...
   * cannot be set directly by callers.
   *
   * @param bool $fromCopiedSpreadsheet
   */
  public function setFromCopiedSpreadsheet($fromCopiedSpreadsheet)
  {
   ...
   * @return bool
   */
  public function getFromCopiedSpreadsheet()
  {
    return $this->fromCopiedSpreadsheet;
  }
  /**
   * Output only. Whether the post is from an imported spreadsheet. This field
   * cannot be set directly by callers.
   *
   * @param bool $fromImportedSpreadsheet
   */
  public function setFromImportedSpreadsheet($fromImportedSpreadsheet)
  {
   ...
   * @return bool
   */
  public function getFromImportedSpreadsheet()
  {
    return $this->fromImportedSpreadsheet;
  }
  /**
   * Output only. The unique ID of the post.
   *
...
class_alias(Post::class, 'Google_Service_Sheets_Post');
