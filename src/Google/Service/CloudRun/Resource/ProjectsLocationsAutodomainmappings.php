 ...
 *  </code>
 */
class Google_Service_CloudRun_Resource_ProjectsLocationsAutodomainmappings extends Google_Service_Resource
{
  /**
   ...
   * (autodomainmappings.listProjectsLocationsAutodomainmappings)
   *
