 ...
 *   $transferResources = $bigquerydatatransferService->projects_locations_transferConfigs_transferResources;
 *  </code>
 */
class ProjectsLocationsTransferConfigsTransferResources extends \Google\Service\Resource
{
  /**
   ...
   * (transferResources.listProjectsLocationsTransferConfigsTransferResources)
   *
   ...
   * @throws \Google\Service\Exception
   */
  public function listProjectsLocationsTransferConfigsTransferResources($parent, $optParams = [])
  {
...
class_alias(ProjectsLocationsTransferConfigsTransferResources::class, 'Google_Service_BigQueryDataTransfer_Resource_ProjectsLocationsTransferConfigsTransferResources');
