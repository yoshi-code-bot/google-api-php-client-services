...
class OptionQuestionsChunk extends \Google\Collection
{
...
class_alias(OptionQuestionsChunk::class, 'Google_Service_CustomerEngagementSuite_OptionQuestionsChunk');
