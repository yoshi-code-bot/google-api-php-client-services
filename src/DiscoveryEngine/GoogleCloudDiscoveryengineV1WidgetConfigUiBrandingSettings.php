...
class_alias(GoogleCloudDiscoveryengineV1WidgetConfigUiBrandingSettings::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1WidgetConfigUiBrandingSettings');
