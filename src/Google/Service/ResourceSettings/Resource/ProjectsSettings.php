 ...
 *  </code>
 */
class Google_Service_ResourceSettings_Resource_ProjectsSettings extends Google_Service_Resource
{
  /**
   ...
   */
  public function listProjectsSettings($parent, $optParams = array())
  {
