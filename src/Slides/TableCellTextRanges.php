...
class TableCellTextRanges extends \Google\Collection
{
  protected $collection_key = 'ranges';
  protected $cellLocationType = TableCellLocation::class;
  protected $cellLocationDataType = '';
  protected $rangesType = TextRange::class;
...
class_alias(TableCellTextRanges::class, 'Google_Service_Slides_TableCellTextRanges');
