...
class ProjectsLocationsGlossaries extends \Google\Service\Resource
{
   ...
   * be created. Format: projects/{projectId}/locations/{locationId} where
   ...
   * must be deleted before a glossary can be deleted. (glossaries.delete)
   *
   * @param string $name Required. The name of the Glossary to delete. Format:
  ...
  /**
   * Retrieves a specified Glossary resource. (glossaries.get)
   *
   * @param string $name Required. The name of the Glossary to retrieve. Format:
   ...
   * glossaries. Format: projects/{project}/locations/{location} Location is the
   * GCP region.
   * @param array $optParams Optional parameters.
   *
   * @opt_param string filter Optional. Filter expression that filters glossaries
   * listed in the response. Initially, no filter is supported.
