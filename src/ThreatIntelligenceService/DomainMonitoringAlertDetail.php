...
class DomainMonitoringAlertDetail extends \Google\Model
{
...
class_alias(DomainMonitoringAlertDetail::class, 'Google_Service_ThreatIntelligenceService_DomainMonitoringAlertDetail');
