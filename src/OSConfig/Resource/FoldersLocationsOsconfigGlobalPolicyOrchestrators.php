...
class_alias(FoldersLocationsOsconfigGlobalPolicyOrchestrators::class, 'Google_Service_OSConfig_Resource_FoldersLocationsOsconfigGlobalPolicyOrchestrators');
