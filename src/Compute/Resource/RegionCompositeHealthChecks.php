 ...
 *   $regionCompositeHealthChecks = $computeService->regionCompositeHealthChecks;
 *  </code>
 */
class RegionCompositeHealthChecks extends \Google\Service\Resource
{
  /**
   ...
   * parameter to `true`. (regionCompositeHealthChecks.aggregatedList)
   *
   ...
   * @return CompositeHealthCheckAggregatedList
  ...
  public function aggregatedList($project, $optParams = [])
  {
    ...
    return $this->call('aggregatedList', [$params], CompositeHealthCheckAggregatedList::class);
  }
  /**
   ...
   * @throws \Google\Service\Exception
   */
  public function delete($project, $region, $compositeHealthCheck, $optParams = [])
  {
   ...
   * (regionCompositeHealthChecks.get)
   *
   * @param string $project Project ID for this request.
   * @param string $region Name of the region scoping this request.
   * @param string $compositeHealthCheck Name of the CompositeHealthCheck resource
   ...
   * @throws \Google\Service\Exception
   */
  public function get($project, $region, $compositeHealthCheck, $optParams = [])
  {
    $params = ['project' => $project, 'region' => $region, 'compositeHealthCheck' => $compositeHealthCheck];
    $params = array_merge($params, $optParams);
   ...
   * @param string $project Project ID for this request.
   * @param string $region Name of the region scoping this request.
   * @param CompositeHealthCheck $postBody
   * @param array $optParams Optional parameters.
   *
   * @opt_param string requestId An optional request ID to identify requests.
   * Specify a unique request ID so that if you must retry your request, the
   ...
   * @throws \Google\Service\Exception
   */
  public function insert($project, $region, CompositeHealthCheck $postBody, $optParams = [])
  {
   ...
   * (regionCompositeHealthChecks.listRegionCompositeHealthChecks)
   *
   * @param string $project Project ID for this request.
   * @param string $region Name of the region scoping this request.
   * @param array $optParams Optional parameters.
   ...
   * single zone scope either returns all resources in the zone or no resources,
   * with an error code.
   * @return CompositeHealthCheckList
   * @throws \Google\Service\Exception
   */
  public function listRegionCompositeHealthChecks($project, $region, $optParams = [])
  {
    $params = ['project' => $project, 'region' => $region];
    $params = array_merge($params, $optParams);
    return $this->call('list', [$params], CompositeHealthCheckList::class);
  }
  /**
   ...
   * (regionCompositeHealthChecks.patch)
   *
   * @param string $project Project ID for this request.
   * @param string $region Name of the region scoping this request.
   * @param string $compositeHealthCheck Name of the CompositeHealthCheck to
   * update. The name must be 1-63 characters long, and comply with RFC1035.
   * @param CompositeHealthCheck $postBody
   * @param array $optParams Optional parameters.
   *
   * @opt_param string requestId An optional request ID to identify requests.
   ...
   * @throws \Google\Service\Exception
   */
  public function patch($project, $region, $compositeHealthCheck, CompositeHealthCheck $postBody, $optParams = [])
  {
    $params = ['project' => $project, 'region' => $region, 'compositeHealthCheck' => $compositeHealthCheck, 'postBody' => $postBody];
    $params = array_merge($params, $optParams);
...
class_alias(RegionCompositeHealthChecks::class, 'Google_Service_Compute_Resource_RegionCompositeHealthChecks');
